...
try {
  ...
  const userBike = new Bike(vehicleColour);
  ...
  const userTruck = new Truck(vehicleColour);
  ...
  const licenseInput = prompt('Now that you have your truck, what is its ' +
  ...
  console.log('The bikes new paint job colour is:', userBike.getColour());
  console.log();
  ...
  console.log('The trucks new paint job colour is:', userTruck.getColour());
  console.log();
